...
switch ( Sys.info()[['sysname']],
         Windows = { directory.root  <-  "C:Asus/Desktop/DATA SCIENCE/Economia y Finanzas/dmeyf" },   #Windows
         Darwin  = { directory.root  <-  "~/dm/" },  #Apple MAC
         Linux   = { directory.root  <-  "~/Escritorio/DATA SCIENCE/Economia y Finanzas/dmeyf"} #Google Cloud
       )
...
karch_generacion  <- "./datasets/paquete_premium_202009_ext-17092021.csv"
karch_aplicacion  <- "./datasets/paquete_premium_202011_ext-17092021.csv"
...
hs <- makeParamSet( 
         ...
         makeNumericParam("prob_corte",       lower= 0.020, upper=    0.045)
        )

campos_malos  <- c("numero_de_cliente","foto_mes","clase_ternaria","entrenamiento",
                   "internet", "Visa_fultimo_cierre", "cmobile_app_trx", 
                   "Master_fultimo_cierre", "tmobile_app", "mforex_sell", 
                   "Visa_mconsumosdolares","mv_fultimo_cierre","mv_mconsumosdolares")  #aqui se deben cargar todos los campos culpables del Data Drifting

ksemilla_azar  <- 123  #Aqui poner la propia semilla
#------------------------------------------------------------------------------
...
kkaggle     <- paste0("./kaggle/lightgbm/E",kexperimento, "_", kscript, "_" )
